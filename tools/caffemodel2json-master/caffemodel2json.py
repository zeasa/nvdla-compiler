...
parser.add_argument(metavar = 'model.caffemodel', dest = 'model_caffemodel', default = './model.caffemodel', help = 'Path to model.caffemodel')
...
parser.add_argument('--caffe.proto', metavar = '--caffe.proto', dest = 'caffe_proto', help = 'Path to caffe.proto (typically located at CAFFE_ROOT/src/caffe/proto/caffe.proto)', default = './model.proto')
